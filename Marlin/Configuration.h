...
#define STRING_CONFIG_H_AUTHOR "(federico, prusa config)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Prusa i3 MK2S MM"
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define  DEFAULT_bedKp 523.82
  #define  DEFAULT_bedKi 76.12
  #define  DEFAULT_bedKd 901.16
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 200, 200, 400, 136 }
...
#define Z_SAFE_HOMING
  ...
  #define Z_SAFE_HOMING_X_POINT 160//((X_MIN_POS + X_MAX_POS) / 2) +23    // X point for Z homing when homing all axis (G28).
  #define Z_SAFE_HOMING_Y_POINT 15//((Y_MIN_POS + Y_MAX_POS) / 2) +9    // Y point for Z homing when homing all axis (G28).
#endif
